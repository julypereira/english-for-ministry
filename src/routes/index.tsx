      ...
      <div className="relative z-10 flex flex-col h-full">
        ...
        <div className="relative mt-auto p-8 flex flex-col sm:flex-row items-center gap-6 animate-in fade-in duration-1000">
          ...
          <div className="flex items-center gap-6">
            <a href="https://www.instagram.com/amigointimochurch_cg?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-[9px] font-black uppercase tracking-[0.3em] text-white/40 hover:text-primary transition-colors">
